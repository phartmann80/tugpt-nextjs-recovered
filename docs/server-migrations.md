...
```
  [ok]   all 50 migration(s) in this checkout are applied (database has 50, latest 20260903000005)
...
`20260903000005` (multi-currency and the Langdock rates). No correction has ever been noticed by a human
