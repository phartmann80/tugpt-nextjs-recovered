...
```
  [ok]   all 51 migration(s) in this checkout are applied (database has 51, latest 20260903000006)
...
`20260903000005` until `20260903000006` (FX conversion). No correction has ever been noticed by a human
