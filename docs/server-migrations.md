...
```
  [ok]   all 49 migration(s) in this checkout are applied (database has 49, latest 20260904000001)
...
(secret storage), and 48 / `20260903000003` until `20260904000001`
(revoking TRUNCATE, TRIGGER and REFERENCES from the browser roles). No
correction has ever been noticed by a human
