...
export const en: Dictionary = {
  ...
  'errors.CONVERSATION_NOT_FOUND': 'Conversation not found',
  'errors.ASSIGNEE_NOT_A_MEMBER': 'That person is not a member of this organization',
  'errors.ASSIGNMENT_CONFLICT': 'Someone else changed this conversation first. Please reload and try again.',
  'errors.INVALID_STATUS_TRANSITION': 'This conversation cannot be changed in its current state',
  'inbox.filter.mine': 'Mine',
  'inbox.filter.unassigned': 'Unassigned',
  'inbox.assignment.all': 'Anyone',
  'inbox.filterByStatus': 'Filter by status',
  'inbox.filterByAssignee': 'Filter by assignee',
  'inbox.assignedTo': 'Assigned to {name}',
  'inbox.assignedToYou': 'Assigned to you',
  'inbox.unassigned': 'Unassigned',
  'inbox.claim': 'Claim',
  'inbox.release': 'Release',
  'inbox.claiming': 'Saving…',
  'inbox.claimFailed': 'Could not change who this conversation is assigned to',
  'thread.handoff': 'Hand off to a human',
  'thread.returnToAi': 'Return to the AI',
  'thread.handedOff': 'The AI is not drafting replies for this conversation.',
  'thread.handoffFailed': 'Could not change the conversation state',
